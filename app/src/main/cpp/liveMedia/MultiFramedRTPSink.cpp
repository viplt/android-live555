...
#define DEBUGSINK True

FILE *logfile2 = fopen("/storage/emulated/0/AudioRecorderMp3/recorder/logsink.txt", "w+");//不能定义多处
////////// MultiFramedRTPSink //////////
...
//#define RTP_PAYLOAD_MAX_SIZE 1440//-----------lt
...
//  fIsFirstPacket = True;//-------lt 临时处理看效果
...
//#ifndef DEBUGSINK
  fprintf(logfile2, "buildAndSendPacket----- %d -----%d ---%d ---%d\n",
	  fIsFirstPacket,fOutBuf->curPacketSize(),fOutBuf->totalBytesAvailable(),fOutBuf->totalBufferSize());
  fflush(logfile2);
//#endif
  packFrame();
}
